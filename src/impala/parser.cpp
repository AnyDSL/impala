...
public:
    ...
    public:
        ...
        operator Loc() const { return {loc_.file, loc_.begin, parser_.prev_loc().finis}; }
    ...
    Tracker track() { return Tracker(*this, lookahead().loc().anew_begin()); }
