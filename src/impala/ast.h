...
protected:
    ...
    void check_type_params(MoveSema&) const;
...
public:
    ...
    virtual void check(MoveSema&) const;
...
public:
    ...
    virtual void insert_payload(LvTree&, const LvMapComparator&, payload_t) const { assert(false); /* overwrite this */ };
...
public:
    ...
    virtual void insert_payload(LvTree&, const LvMapComparator&, payload_t) const override;
