...
protected:
    ...
    void infer_type_params(InferSema&) const;
...
public:
    ...
    virtual void infer(InferSema&) const override;
...
public:
    ...
    virtual void infer(InferSema&) const;
    virtual std::ostream& print(Printer&) const override;
